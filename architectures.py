...
def get_architecture(arch: str, dataset: str=None, pytorch_pretrained: bool=False) -> torch.nn.Module:
    ...
    # Encoder and Decoders
        ...
        model = Cifar_Encoder_192_24_noise(norm_layer=models.NoisyBatchNorm2d)
        return model
    elif arch == "cifar_decoder_192_24_noise":
        # model = Cifar_Decoder_192_24_noise().cuda()
        model = Cifar_Decoder_192_24_noise(norm_layer=models.NoisyBatchNorm2d)
        return model
