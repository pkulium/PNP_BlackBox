...
class Cifar_Encoder_192_24_noise(nn.Module):
    def __init__(self, norm_layer=None):
        super(Cifar_Encoder_192_24_noise, self).__init__()
...
class Cifar_Decoder_192_24_noise(nn.Module):
    def __init__(self, norm_layer=None):
        super(Cifar_Decoder_192_24_noise, self).__init__()
